...
const store = new Vuex.Store({
  plugins: [initializeModules, initializeNotifications],
  modules: {
...
class mockAddAccountCommand
  implements Command<AddAccountRequest, AddAccountResponse>
{
...
container.addTransient<AddAccountCommand>(
  mockAddAccountCommand,
  "AddAccountCommand"
);

...
namespace Platform8.FinancialAccounts.Tests
{
  ...
  public class When_AddBalance_Requested : SpecBase
  {
    ...
    Establish context = () =>
    {
      ...
      Sut.SetupAsync<IAsyncRepository<FinancialAccountsDataContext, Models.Account>, Models.Account>(r => r.GetAsync(Argument.Is<Guid>(x => x == testAccount.Id), Argument.IsAny<CancellationToken>()))

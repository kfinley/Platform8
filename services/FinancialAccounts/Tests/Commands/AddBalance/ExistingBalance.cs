...
namespace Platform8.FinancialAccounts.Tests
{
  ...
  public class When_AddBalance_Requested_with_existing_balance : SpecBase
  {
    ...
    Establish context = () =>
    {
      ...
      Sut.SetupAsync<IAsyncRepository<FinancialAccountsDataContext, Models.Balance>, Models.Balance>(r =>
    ...
    {
      Sut.Verify<IAsyncRepository<FinancialAccountsDataContext, Models.Balance>>(p => p.SaveAsync(Argument.IsAny<Models.Balance>(), Argument.IsAny<CancellationToken>()), Times.Never());
    };
    ...
    {
      Sut.Verify<IAsyncRepository<FinancialAccountsDataContext, Models.Balance>>(p => p.FirstOrDefaultAsync(Argument.IsAny<Expression<Func<Models.Balance, bool>>>(), Argument.IsAny<CancellationToken>()), Times.Once());
    };

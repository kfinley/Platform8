...
namespace Platform8.Accounts.Api
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services
        ...
        .AddDbContext<AccountsDataContext>(options =>
          options.UseMySql(Configuration.GetConnectionString("DefaultConnection"),
                           ...
                           x => x.MigrationsAssembly("Accounts.Api"))
      ...
      {
        c.SwaggerDoc("v1", new OpenApiInfo { Title = "Platform8 Accounts Api", Version = "v1" });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
      if (env.IsDevelopment())
      {
        ...
        app.UseSwagger();
        app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Platform8 Accounts Api v1"));
      }
